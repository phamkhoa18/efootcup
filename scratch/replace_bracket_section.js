...
const file = path.resolve('app/(main)/giai-dau/[id]/TournamentDetailClient.tsx');
let content = fs.readFileSync(file, 'utf8');

const regex = /const renderPublicBracketSection = \(sectionRounds: typeof bracketRounds, sectionKey: string\) => \{[\s\S]*?return \([\s\S]*?\);\n    \};/g;

const newFunc = `const renderPublicBracketSection = (sectionRounds: typeof bracketRounds, sectionKey: string) => {
